...
class HasLikesTest extends TestCase
{
     ...
     * @test
     */
    public function an_model_knows_if_it_has_liked()
    {
        $model = new ModelWhitLikes(['id' => 1]);
     ...
     * @test
     */
    public function an_model_knows_how_many_likes_it_has()
    {
        $model = new ModelWhitLikes(['id' => 1]);
...
class ModelWhitLikes extends Model
{
    use HasLikes;
