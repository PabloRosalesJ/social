...
class StatusTest extends TestCase
{
     ...
     * @test
     */
    public function a_statust_has_many_likes()
    {
        $status = factory(Status::class)->create();
     ...
     * @test
     */
    public function a_statust_can_be_liked_and_unliked()
    {
        $status = factory(Status::class)->create();
     ...
     * @test
     */
    public function a_statust_can_be_liked_once()
    {
        $status = factory(Status::class)->create();
     ...
     * @test
     */
    public function an_status_knows_if_it_has_liked()
    {
        $status = factory(Status::class)->create();
     ...
     * @test
     */
    public function an_status_knows_how_many_likes_it_has()
    {
        $status = factory(Status::class)->create();
